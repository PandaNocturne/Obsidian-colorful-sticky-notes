        ...
        addFile(e) {
            ...
            this.addItem((o) => {
                if (
                    ...
                    n &&
                        o.dom.createDiv({ text: "" + n, cls: "nav-file-tag qe-file-count" });
                }
        ...
        onload() {
                    ...
                    W(
                        ...
                        (s, a) => {
                            ...
                            if (
                                ...
                                return (l = fe(a)) == null || l.open(s), s.stopPropagation(), !1;
                        },
                        { capture: !0 }
                    )
                ),
            ...
            if ((this.register(() => M(e, this)), T(e, this), this.isCurrent()))
                ...
                let n = app.workspace.getMostRecentLeaf(this.container),
                    s = (n == null ? void 0 : n.view) instanceof c.FileView && n.view.file;
                s && this.update(s);
            }
